...
class BWtrainer:
    ...
    def _forward(self, seq):
        ...
        # 初始化第一个时间步
        alpha[0] = alpha[0] = self.pi * self.B[:, seq[0]] ## fill in this blank with an expression ##
    ...
    def _backward(self, seq, scaling_factors):  
        ...
        for t in range(T-2, -1, -1):
            beta[t] = beta[t] = np.dot(self.A * self.B[:, seq[t+1]], beta[t+1]) ## fill in this blank with an expression ##
